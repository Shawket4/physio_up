...
class _TherapistDetailsScreenState extends State<TherapistDetailsScreen> {
    ...
    return BlocProvider(
      ...
      child: BlocBuilder<TherapistCubit, TherapistState>(
        builder: (context, state) {
          final cubit =
              context.read<TherapistCubit>(); // Efficient state access
                ...
                Container(
                  ...
                  child: TableCalendar(
                    ...
                    eventLoader: (day) {
                      ...
                      if (cubit.bookedSlots.containsKey(normalizedDate)) {
                        return cubit.bookedSlots[normalizedDate]!.map((block) {
                          return block.appointment?.patientName == ""
                              ? "Blocked"
                              : "Booked";
                        }).toList();
                      }
  ...
  Widget _buildAppointmentsList(TherapistCubit cubit) {
