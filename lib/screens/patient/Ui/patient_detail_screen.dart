...
class PatientDetailScreen extends StatelessWidget {
                      ...
                      SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            const SizedBox(width: 16),
                            // Package Card
                            _buildPackageCard(context, treatmentPlan, theme),
                          ],
                        ),
                      ),
                    ],
                            ...
                            return Card(
                              ...
                              child: ListTile(
                                ...
                                leading: CircleAvatar(
                                  ...
                                  child: Icon(
                                    appointment.isCompleted ? Icons.check : Icons.pending,
  ...
  Widget _buildPackageCard(BuildContext context, TreatmentPlan treatmentPlan, ThemeData theme) {
    final bool hasActivePackage = treatmentPlan.id != 0 && treatmentPlan.id != null;
          ...
          child: Column(
            ...
            children: [
              ...
              if (hasActivePackage) ...[
                const Divider(),
                Text(
                  treatmentPlan.superTreatmentPlan?.description ?? "No description",
                  style: const TextStyle(
                    fontSize: 15,
                    fontWeight: FontWeight.w500,
                  ),
