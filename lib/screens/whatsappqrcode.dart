...
class _WhatsAppQRCodeState extends State<WhatsAppQRCode> {
  ...
  void _refreshQRCode() async {
    ...
    try {
      // This is a placeholder - implement actual QR refresh
      await Future.delayed(const Duration(seconds: 2));
      // In a real app, you would fetch a new QR code here
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Lottie.asset(
                    "assets/lottie/whatsapp_animation.json", // Replace with your actual asset
                    height: 120,
                    width: 120,
                  ),
